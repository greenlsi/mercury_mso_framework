...
from .internal_ports import ChangeStatus, SetDVFSMode, OpenSession, CloseSession
...
class ProcessingUnitMultiplexer(Multiplexer):
    ...
    def __init__(self, name, n_pu):
        ...
        self.input_open_session = Port(OpenSession, name + '_input_create_session')
        self.input_close_session = Port(CloseSession, name + '_input_remove_session')
        ...
        self.outputs_open_session = [Port(OpenSession, name + '_output_open_session_' + str(i)) for i in p_units]
        self.outputs_close_session = [Port(CloseSession, name + '_output_close_session_' + str(i)) for i in p_units]
